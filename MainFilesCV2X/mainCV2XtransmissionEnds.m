function [phyParams,simValues,outputValues,sinrManagement,stationManagement,timeManagement,expManagement,sinrThreshold] = ...
...
if ~isempty(stationManagement.transmittingIDsCV2X)   
    ...
    [stationManagement,sinrManagement,outputValues,simValues,expManagement] = updateKPICV2X(activeIDsTXLTE,indexInActiveIDsOnlyLTE,awarenessID_LTE,neighborsID_LTE,timeManagement,stationManagement,positionManagement,sinrManagement,outputValues,outParams,simParams,appParams,phyParams,simValues,...
        expManagement);
