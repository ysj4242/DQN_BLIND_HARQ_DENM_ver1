...
%     sensingMatrix(:,currentT+1:end,:) = circshift(sensingMatrix(:,currentT+1:end,:), 1, 2);
    ...
    for i = 1 : length(vehiclesToConsider)
        sinrManagement.cbrCV2X(vehiclesToConsider(i),sinrManagement.a(vehiclesToConsider(i))) = sum(~subchannelFree(:,:,i), [1, 2]) ./ numel(subchannelFree(:,:,1));
        sinrManagement.a(vehiclesToConsider(i)) = sinrManagement.a(vehiclesToConsider(i)) + 1;
    end
...
if simParams.dcc_active
    ...
    CRlimit_PPPP1 = (1*(CBRvalues<=0.3) + 0.03*(CBRvalues>0.3 & CBRvalues<=0.65) +  0.006*(CBRvalues>0.65 & CBRvalues<=0.8) + 0.004*(CBRvalues>0.8))*phyParams.cv2xCbrFactor;
    % CRlimit = (1*(CBRvalues<=0.3) + 0.03*(CBRvalues>0.3 & CBRvalues<=0.65) + 0.006*(CBRvalues>0.65 & CBRvalues<=0.8) + 0.003*(CBRvalues>0.8))*phyParams.cv2xCbrFactor;
%     DENM_l = zeros(length(stationManagement.activeIDs),1);
    a = [];
    for s = 1 : length(vehiclesToConsider)
        if phyParams.cv2xNumberOfReplicasMax>1 && stationManagement.DENM_pck(vehiclesToConsider(s)) == 1
                % (Vittorio 5.5.3)
                ...
                CR = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) * (phyParams.NsubchannelsBeacon)/(phyParams.NsubchannelsFrequency) * phyParams.TTI / timeManagement.generationIntervalDeterministicPart(vehiclesToConsider(s));
                %fprintf('%f\n',CR);
                if simParams.Priority_DCC == 1
                    while CBRvalues(s) >= 0.3  && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
%                         if stationManagement.pckNextAttempt(vehiclesToConsider(s))==2
%                             disp(1)
%                         end
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        stationManagement.DENM_l(vehiclesToConsider(s)) = 1;
                    end
                
                elseif simParams.Priority_DCC == 2
                    while CBRvalues(s) >= 0.65  && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end

                elseif simParams.Priority_DCC == 3
                    while CBRvalues(s) >= 0.9  && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                    while (0.9 > CBRvalues(s)) && (CBRvalues(s) >= 0.8) && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                elseif simParams.Priority_DCC == 4
                    while CBRvalues(s) >= 0.95  && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                    while (0.95 > CBRvalues(s)) && (CBRvalues(s) >= 0.85) && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                elseif simParams.Priority_DCC == 5
                    while CBRvalues(s) >= 0.85  && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                    while (0.85 > CBRvalues(s)) && (CBRvalues(s) >= 0.75) && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                elseif simParams.Priority_DCC == 6
                    while CBRvalues(s) >= 0.9  && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                    ...
                    while (0.9 > CBRvalues(s)) && (CBRvalues(s) >= 0.7) && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                elseif simParams.Priority_DCC == 7
                    while CBRvalues(s) >= 0.9  && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                    ...
                    while (0.9 > CBRvalues(s)) && (CBRvalues(s) >= 0.65) && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                elseif simParams.Priority_DCC == 8
                    while CBRvalues(s) >= 0.95  && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                    ...
                    while (0.95 > CBRvalues(s)) && (CBRvalues(s) >= 0.9) && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                elseif simParams.Priority_DCC == 9
                    while CBRvalues(s) >= 0.95  && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                    ...
                    while (0.95 > CBRvalues(s)) && (CBRvalues(s) >= 0.87) && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                elseif simParams.Priority_DCC == 10
                    while CBRvalues(s) >= 0.95  && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                    ...
                    while (0.95 > CBRvalues(s)) && (CBRvalues(s) >= 0.8) && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                elseif simParams.Priority_DCC == 11
                    while CBRvalues(s) >= 0.97  && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                    while (0.97 > CBRvalues(s)) && (CBRvalues(s) >= 0.87) && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                elseif simParams.Priority_DCC == 12
                    while CBRvalues(s) >= 0.97  && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                    ...
                    while (0.97 > CBRvalues(s)) && (CBRvalues(s) >= 0.85) && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                elseif simParams.Priority_DCC == 13
                    while CBRvalues(s) >= 0.97  && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                    ...
                    while (0.97 > CBRvalues(s)) && (CBRvalues(s) >= 0.8) && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                elseif simParams.Priority_DCC == 14
                    while CBRvalues(s) >= 0.92  && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                    while (0.92 > CBRvalues(s)) && (CBRvalues(s) >= 0.85) && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                elseif simParams.Priority_DCC == 15
                    while CBRvalues(s) >= 0.9  && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                    ...
                    while (0.9 > CBRvalues(s)) && (CBRvalues(s) >= 0.85) && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                elseif simParams.Priority_DCC == 16
                    while CBRvalues(s) >= 0.93  && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                    while (0.93 > CBRvalues(s)) && (CBRvalues(s) >= 0.85) && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                elseif simParams.Priority_DCC == 17
                    while CBRvalues(s) >= 0.96  && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                    while (0.96 > CBRvalues(s)) && (CBRvalues(s) >= 0.86) && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                elseif simParams.Priority_DCC == 18
                    while CBRvalues(s) >= 0.96  && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                    ...
                    while (0.96 > CBRvalues(s)) && (CBRvalues(s) >= 0.85) && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                elseif simParams.Priority_DCC == 19
                    while CBRvalues(s) >= 0.95  && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                    ...
                    while (0.95 > CBRvalues(s)) && (CBRvalues(s) >= 0.86) && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                elseif simParams.Priority_DCC == 20
                    while CBRvalues(s) >= 0.97  && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                    ...
                    while (0.97 > CBRvalues(s)) && (CBRvalues(s) >= 0.86) && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                elseif simParams.Priority_DCC == 21
                    while CBRvalues(s) >= 0.96  && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                    ...
                    while (0.96 > CBRvalues(s)) && (CBRvalues(s) >= 0.87) && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                elseif simParams.Priority_DCC == 22
                    while CBRvalues(s) >= 0.9  && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                ...
                elseif simParams.Priority_DCC == 23
                    while CBRvalues(s) >= 0.95  && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
%                         if DENM_l(vehiclesToConsider(s)) == 0 && stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) == 2
%                             disp(1)
%                         end
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        DENM_l(vehiclesToConsider(s)) = DENM_l(vehiclesToConsider(s)) + 1;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                 elseif simParams.Priority_DCC == 24
                    while CBRvalues(s) >= 0.97  && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                ...
                elseif simParams.Priority_DCC == 25
                    while CBRvalues(s) >= 0.99  && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                 elseif simParams.Priority_DCC == 26
                    while CBRvalues(s) >= 0.95  && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                    ...
                    while (0.95 > CBRvalues(s)) && (CBRvalues(s) >= 0.93) && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                elseif simParams.Priority_DCC == 27
                    while CBRvalues(s) >= 0.99  && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                    ...
                    while (0.99 > CBRvalues(s)) && (CBRvalues(s) >= 0.95) && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                elseif simParams.Priority_DCC == 28
                    while CBRvalues(s) >= 0.98  && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                    while (0.98 > CBRvalues(s)) && (CBRvalues(s) >= 0.95) && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                elseif simParams.Priority_DCC == 29
                    while CBRvalues(s) >= 0.97  && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                    ...
                    while (0.97 > CBRvalues(s)) && (CBRvalues(s) >= 0.95) && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                elseif simParams.Priority_DCC == 30
                    while CBRvalues(s) >= 0.99  && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                    ...
                    while (0.99 > CBRvalues(s)) && (CBRvalues(s) >= 0.96) && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                elseif simParams.Priority_DCC == 31
                    while CBRvalues(s) >= 0.99  && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                    ...
                    while (0.99 > CBRvalues(s)) && (CBRvalues(s) >= 0.97) && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                elseif simParams.Priority_DCC == 32
                    while CBRvalues(s) >= 0.99  && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                    ...
                    while (0.99 > CBRvalues(s)) && (CBRvalues(s) >= 0.98) && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                elseif simParams.Priority_DCC == 33
                    while CBRvalues(s) >= 0.99  && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                    ...
                    while (0.99 > CBRvalues(s)) && (CBRvalues(s) >= 0.94) && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                elseif simParams.Priority_DCC == 34
                    while CBRvalues(s) >= 0.99  && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                    ...
                    while (0.99 > CBRvalues(s)) && (CBRvalues(s) >= 0.93) && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                    end
                elseif simParams.Priority_DCC == 35
                    while CBRvalues(s) >= 0.99  && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                    ...
                    while (0.99 > CBRvalues(s)) && (CBRvalues(s) >= 0.92) && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                        % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                        % DENM_l(vehiclesToConsider(s)) = 1;
                ...
                % while (CR > CRlimit(s)) && (stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))>1)
                %     stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))-1;
                %     % stationManagement.pckNextAttempt(vehiclesToConsider(s)) = 1;
                %     stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehiclesToConsider(s))) = true;
                %     DENM_l(vehiclesToConsider(s)) = 1;
                ...
                if stationManagement.pckBuffer(vehiclesToConsider(s))>0 && ...
                        stationManagement.pckNextAttempt(vehiclesToConsider(s)) > stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s))
                    [stationManagement,outputValues] = bufferOverflowLTE(vehiclesToConsider(s),timeManagement,positionManagement,stationManagement,phyParams,appParams,outputValues,outParams);
                end
        end
    end
    %(Vittorio 5.5.3)
    ...
    for s = 1 : length(vehiclesToConsider)
        if stationManagement.DENM_pck(vehiclesToConsider(s)) == 0
	        timeManagement.dcc_minInterval(vehiclesToConsider(s)) = stationManagement.cv2xNumberOfReplicas(vehiclesToConsider(s)) .* (phyParams.NsubchannelsBeacon)/(phyParams.NsubchannelsFrequency) * phyParams.TTI ./ CRlimit(s);
        end
    end
    % a = find(DENM_l);
    % if find(a)
    %     stationManagement.DENM_pck(a) = 0;
    % end
