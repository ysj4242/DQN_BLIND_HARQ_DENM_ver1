...
%          end
         ...
         outputValues.NerrorsCV2X_DENM(iChannel,pckType,iPhyRaw) = outputValues.NerrorsCV2X_DENM(iChannel,pckType,iPhyRaw) + NtxBeacons;
         ...
         outputValues.NtxBeaconsCV2X_DENM(iChannel,pckType,iPhyRaw) = outputValues.NtxBeaconsCV2X_DENM(iChannel,pckType,iPhyRaw) + NtxBeacons;
