...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 300
% A = load('3rep_800_np_nd.mat');        %black
% B = load('2rep_800_np_nd.mat');        %
% C = load('3rep_400_np_nd.mat');         %red
% D = load('2rep_400_np_nd.mat');         %
% E = load('3rep_200_np_nd.mat');         %blue
% F = load('2rep_200_np_nd.mat');         %
% G = load('2rep_200_p5_d1.5.mat');         %green
% H = load('2rep_200_p5_dc.mat');         %
...
A = load('3rep_800_np_nd.mat');         %black
B = load('3rep_800_np_d10.mat');         %red
C = load('3rep_800_np_d4.mat');           %blue
D = load('3rep_800_np_d11.mat');          %green
E = load('3rep_800_np_d6.mat');         %magenta
F = load('3rep_800_np_d13.mat');           %
G = load('3rep_800_np_d8.mat');           %c
H = load('3rep_800_np_d9.mat');           %
...
lgd = legend({'3rep, ρ=800, no DCC','2rep, ρ=800, DCC','3rep, ρ=800, DCC' ,'np, ρ=400','p5, ρ=200','np, ρ=200',},'Orientation','horizontal');
